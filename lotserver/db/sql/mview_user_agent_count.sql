--TRUNCATE TABLE
TRUNCATE TABLE USER_REGISTER_REPORT ;
TRUNCATE TABLE FUND_CHANGE_LOG_REPORT ;
...
delete from  mview_user_agent_count where trunc(day) < trunc(sysdate - 14) ; 			 
